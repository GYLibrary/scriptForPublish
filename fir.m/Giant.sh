...
#指定项目地址
workspace_path="$project_path/OzneriFamily.xcworkspace"
#指定输出路径
output_path="$project_path/IPA"
#指定输出归档文件地址
archive_path="$output_path/Demo_${now}.xcarchive"
#指定输出ipa地址
ipa_path="$output_path/OzneriFamily_${now}.ipa"
#指定输出ipa名称
ipa_name="OzneriFamily_${now}.ipa"
...
#上传到fir
fir publish ${ipa_path} -T "afe6416ded4e08574a925f11c66ba23e" -c "${commit_msg}"
